...
# Save results
output_dir = "/Users/shashankramachandran/desktop/Research/results/LAI-KNN-TREES-ENSEMBLE"
os.makedirs(output_dir, exist_ok=True)

output_path = os.path.join(output_dir, "knn_extratrees_blending_res_results.csv")
