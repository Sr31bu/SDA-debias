...
# === Load dataset ===
file_path = "/Users/shashankramachandran/desktop/Research/cleaned_data_allyears/ModelingDatasets/SoilMoistFrac_modeling_dataset.csv"
df = pd.read_csv(file_path)

# === Clean data ===
df = df.dropna()

# Extract year if it's a full date string
...
use_bayesian_params = False
params_to_use = bayesian_optimized_params if use_bayesian_params else default_params
 
# === Train ExtraTrees model ===
model = ExtraTreesRegressor(**params_to_use)
...
print("SoilMoistFrac Residual Model Performance")
...
output_dir = "/Users/shashankramachandran/desktop/Research/results/SoilMoistFrac"
os.makedirs(output_dir, exist_ok=True)

# === Save summary stats to text file ===
summary_path = os.path.join(output_dir, "summary.txt")
with open(summary_path, "w") as f:
    f.write("SoilMoistFrac Residual Modeling Results\n")
